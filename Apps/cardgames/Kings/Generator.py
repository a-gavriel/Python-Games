...
class card():
	playing_number : int = 0
	effect : str = ""
	explanation : str = ""

	def __init__(self, playing_number = 0, effect = "", explanation = "") -> None:
		self.playing_number = playing_number
		self.effect = effect
		self.explanation = explanation

card_1 = card(1, "Physical Rule")
card_2 = card(2, "Paranoia")
card_3 = card(3, "Oral Rule")
card_4 = card(4, "Floor")
card_5 = card(5, "Guys")
card_6a = card(6, "Chicks")
card_6b = card(6, "All Drink")
card_7 = card(7, "Heaven")
card_8 = card(8, "Mate")
card_9 = card(9, "Truth or Dare")
card_10 = card(10, "Topic")
card_11a = card(11, "Never have I ever ...")
card_11b = card(11, "I have ...")
card_12 = card(12, "Question Master")
card_13 = card(13, "King")
